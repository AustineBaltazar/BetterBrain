...
public class ImageAdapterTutorial extends PagerAdapter {
    ...
    private int[] mImageIds = new int []{R.drawable.matchtuts1,R.drawable.matchtuts2, R.drawable.reactiontuts1,
    R.drawable.reactiontuts2,R.drawable.reactiontuts3, R.drawable.anagramtuts1, R.drawable.anagramtuts2, R.drawable.anagramtuts3,
